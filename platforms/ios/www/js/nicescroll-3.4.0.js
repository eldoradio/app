/* NiceScroll | version 3.4.0 | copyright 2011-12-13 InuYaksa*2013 | licensed under the MIT */
	...
	// Let's start!  
	    ...
	    do {
	      this.id = "scrollbar-"+(scrollrailcounter++);
	...
	*/  
	  ...
	  $.fn.scrollbar = function(wrapper,opt) {        
